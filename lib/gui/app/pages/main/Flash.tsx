...
interface FlashStepState {
	...
	drivesWithWarnings: Array<
		constraints.DrivelistDrive & { statuses: constraints.DriveStatus[] }
	>;
}
		...
		if (hasDangerStatus) {
			this.setState({
				drivesWithWarnings: drives.filter((driveWithWarnings) => {
					...
					const system = drives.some((drive) =>
				...
				{this.state.warningMessage && (
					...
					>
						...
						>
							...
							<Txt fontSize="24px">These targets will be erased:</Txt>
							<ScrollableFlex
								flexDirection="column"
								...
								maxHeight="100px"
							>
								{this.state.drivesWithWarnings.map((drive, i, array) => (
									<>
										<Flex justifyContent="space-between" alignItems="baseline">
											<strong>{middleEllipsis(drive.description, 34)}</strong>{' '}
							...
							<Txt style={{ fontWeight: 600 }}>
								Are you sure you want to flash these targets?
							</Txt>
						</Flex>
					</Modal>
				)}
